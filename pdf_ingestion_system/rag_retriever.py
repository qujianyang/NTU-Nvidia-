...
class CourseRAGRetriever:
    ...
    def answer_question(self, question: str) -> str:
        ...
        context_parts = []
        course_info_list = []  # Store course info for prompt
        ...
        for i, doc in enumerate(parent_docs, 1):
            ...
            # Store course info for inclusion in response
            if course_url:
                course_info_list.append(f"{course_title}: {course_url}")
...
- IMPORTANT: When recommending or mentioning specific courses, always include their URLs
- Format course mentions as: "Course Title (URL)" or include the URL right after the course name
- Use the URLs provided in the "AVAILABLE COURSE LINKS" section when available
